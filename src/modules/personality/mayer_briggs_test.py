# -*- coding: utf-8 -*-
"""Decoding You: The Mayer Briggs Personality Test Project.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1XqDJ8f8KcXXh_4SY3xC9LhUTHzRl28Mx
"""
    ...
    for question in questions:
        ...
        if count == 5:
            if count_of_a > count_of_b:
                personality_dichotomy += 'E '
            else:
                personality_dichotomy += 'I '
        elif count == 10:
            if count_of_a > count_of_b:
                personality_dichotomy += 'S '
            else:
                personality_dichotomy += 'N '
        elif count == 15:
            if count_of_a > count_of_b:
                personality_dichotomy += 'T '
            else:
                personality_dichotomy += 'F '
        elif count == 20:
            if count_of_a > count_of_b:
                personality_dichotomy += 'J '
            else:
                personality_dichotomy += 'P '
